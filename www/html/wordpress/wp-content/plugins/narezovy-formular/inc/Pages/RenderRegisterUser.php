        ...
        ?>
            <form method="post" class="register-form" id="register-user-form">
                ...
                <div class="form-section">    
                    ...
                    <input type="text" name="nf_jmeno" style="width: 300px;" required></input>    
                </div>
                <div class="form-section">    
                    <label for="prijmeni">*Příjmení:</label><br>
                    <input type="text" name="nf_prijmeni" style="width: 300px;" required></input>    
                </div>
                <div class="form-section">    
                    <label for="email">*Email:</label><br>
                    <input type="email" name="nf_email" style="width: 300px;" required></input>    
                </div>
                <div class="form-section">    
                ...
                <div class="form-section">    
                    ...
                    <input type="text" name="nf_mesto" style="width: 300px;" required></input>    
                </div>
                <div class="form-section">    
