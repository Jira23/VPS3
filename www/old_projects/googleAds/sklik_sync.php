...
*/    
    ...
    $campaignId = 2506239;                                                      // Id kampane sklik
    ...
    //$data = BW_data_load('/var/www/core/short_example.xml');
    ...
    //$cc->generalRequest('campaigns.create', array(array('name' => 'test', 'dayBudget' => 10000, 'type' => 'fulltext')), $lg);                           // vytvori kampan
    //exit;
